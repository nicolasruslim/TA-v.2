...
--
-- Host: localhost
-- Generation Time: Jun 14, 2015 at 06:16 PM
...
(12, 'Broccoli & Stilton soup', 'Broccoli & Stilton soup', 2, 'A smooth blended vegetable soup with blue cheese that''s as good for a comforting meal as it is for a dinner party starter', 4, '{"compositions":[     {"composition":"2 tbsp rapeseed oil"},     {"composition":"1 onion, finely chopped"},     {"composition":"1 stick celery, sliced"},     {"composition":"1 leek, sliced"},     {"composition":"1 medium potato, diced"},     {"composition":"1 knob butter"},     {"composition":"1l low salt or homemade chicken or vegetable stock"},     {"composition":"1 head broccoli, roughly chopped"},     {"composition":"140g Stilton, or other blue cheese, crumbled"} ]}', '{"howtos":[\r\n    {"howto":"Heat the rapeseed oil in a large saucepan and then add the onions. Cook on a medium heat until soft. Add a splash of water if the onions start to catch."},\r\n    {"howto":"Add the celery, leek, potato and a knob of butter. Stir until melted, then cover with a lid. Allow to sweat for 5 minutes. Remove the lid.)"},\r\n    {"howto":"Pour in the stock and add any chunky bits of broccoli stalk. Cook for 10 – 15 minutes until all the vegetables are soft.)"},\r\n    {"howto":"Add the rest of the broccoli and cook for a further 5 minutes. Carefully transfer to a blender and blitz until smooth. Stir in the stilton, allowing a few lumps to remain. Season with black pepper and serve.)"}\r\n]}', 3, 4);
